...
function HomeScreen({transactions, onNav, userName}) {
  ...
  return (
    <div style={{padding:'0 16px 100px',color:T.text,fontFamily:'-apple-system,system-ui'}}>
...
function PortfolioScreen({transactions}) {
  ...
  return (
    <div style={{color:T.text,fontFamily:'-apple-system,system-ui',padding:'0 16px 100px'}}>
      <div style={{paddingTop:72,marginBottom:14,display:'flex',alignItems:'center',justifyContent:'space-between'}}>
...
function HistoryScreen({transactions, onDelete}) {
  ...
  return (
    <div style={{color:T.text,fontFamily:'-apple-system,system-ui',padding:'0 16px 100px'}}>
      <div style={{paddingTop:72,marginBottom:14}}>
